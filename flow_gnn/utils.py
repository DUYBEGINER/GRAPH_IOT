...
def get_device(device_str: str = "auto") -> torch.device:
    ...
    if device_str == "auto":
        if torch.cuda.is_available():
            ...
            logging.info("Using Apple Metal (MPS)")
        else:
...
def save_metrics_plots(y_true: np.ndarray, y_pred: np.ndarray, 
    ...
    ax.set_title('Normalized Confusion Matrix - Flow GNN', fontsize=14, fontweight='bold')
    ax.set_ylabel('True Label', fontsize=12)
    ax.set_xlabel('Predicted Label', fontsize=12)
    plt.tight_layout()
    ...
    ax.fill_between(recall_curve, precision_curve, alpha=0.2, color='#4CAF50')
    ax.set_xlim([0.0, 1.0])
    ax.set_ylim([0.0, 1.05])
    ax.set_xlabel('Recall', fontsize=12)
    ax.set_ylabel('Precision', fontsize=12)
    ax.set_title('Precision-Recall Curve - Flow GNN', fontsize=14, fontweight='bold')
    ...
    ax.set_title('Performance Metrics - Flow GNN', fontsize=14, fontweight='bold')
    ...
    # =========================================================================
    # 7. ALL METRICS SUMMARY (with latency)
    # =========================================================================
    ...
    logging.info(f"📊 Plots saved to {output_path}/")
